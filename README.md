...
python train_scannet.py --config configs/gnt_scannet.txt \
       --ckpt_path ./out/gnt_smeantic_0831_4/model_stage_2.pth --expname frozen_gnt4 --val_set_list configs/scannetv2_test_split.txt --no_load_opt --no_load_scheduler

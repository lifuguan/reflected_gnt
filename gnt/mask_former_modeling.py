...
from .mask_former.criterion import SetCriterion
from .mask_former.matcher import HungarianMatcher
...
class MaskFormer(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "sem_seg_postprocess_before_inference": (
                cfg.MODEL.MASK_FORMER.SEM_SEG_POSTPROCESSING_BEFORE_INFERENCE
            ),
    ...
    def forward(self, batched_inputs):
        ...
        # images = batched_inputs['image'].sequeeze(0)
